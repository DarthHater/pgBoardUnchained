...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Thread'
        db.create_table(u'board_thread', (
        ...
        db.send_create_signal(u'board', ['Thread'])

        # Adding model 'Post'
        db.create_table(u'board_post', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ...
        db.send_create_signal(u'board', ['Post'])


    def backwards(self, orm):
        # Deleting model 'Thread'
        db.delete_table(u'board_thread')

        # Deleting model 'Post'
        db.delete_table(u'board_post')
